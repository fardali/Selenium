...
public class FormSendTest extends PageBase {
    ...
    public SendFormResultPage fillFormAndSend(){
        ...
        this.waitAndReturnElement(nameInputXpath).sendKeys("testertestertester");

        this.waitAndReturnElement(phoneNumberXpath).click();
        this.waitAndReturnElement(phoneNumberXpath).sendKeys("0644444443");

        this.waitAndReturnElement(checkboxXpath).click();

        this.waitAndReturnElement(emailXpath).click();
        this.waitAndReturnElement(emailXpath).sendKeys("fardaliiii@gmail.com");

        this.waitAndReturnElement(emailRetypeXpath).click();
        this.waitAndReturnElement(emailRetypeXpath).sendKeys("fardaliiii@gmail.com");
