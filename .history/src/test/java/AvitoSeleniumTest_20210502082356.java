...
public class AvitoSeleniumTest {
    ...
    @Test
    public void testing(){ // this function tests form sending + logout 
        FormSendTest formSend = new FormSendTest(this.driver);
        SendFormResultPage sfrp = formSend.fillFormAndSend("daliyou","0642385777","templlliu@gmail.com"); //after running tests twice change the phone number to a random phone number starting with 06XXXXXXXX and a random email
