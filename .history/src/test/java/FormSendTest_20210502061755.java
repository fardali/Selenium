...
public class FormSendTest extends PageBase {
    ...
    private By cityXpathInput = By.xpath("//*[@id='__next']/div/main/div/form/div[2]/div/div[1]/div[4]/div/div/div[1]/input");
    private By cityInput = By.name("region");
    private By cityCasablanca = By.xpath("//*[@id='__next']/div/main/div/form/div[2]/div/div[1]/div[4]/div/div/div[1]/div");
    ...
    public void fillFormAndSend(){
        ...
        this.waitAndReturnElement(cityInput).setAttribute("value", "Casablanca");
