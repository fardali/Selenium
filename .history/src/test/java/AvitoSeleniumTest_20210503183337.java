...
public class AvitoSeleniumTest {
    ...
    public void testAll(){
        ...
        SendFormResultPage sfrp = formSend.fillFormAndSend("dalila youssef","0614777701","tem7lluyl01u@gmail.com"); //after running tests twice change the phone number to a random phone number starting with 06XXXXXXXX and a random email
