...
public class AvitoSeleniumTest {
    ...
    public void testAll(){
        ...
        SendFormResultPage sfrp = formSend.fillFormAndSend("fardali youssef","0614777701","tm66ytu@gmail.com"); //after running tests twice change the phone number to a random phone number starting with 06XXXXXXXX and a random email
