...
public class AvitoSeleniumTest {
    ...
    public void testAll(){
        ...
        SendFormResultPage sfrp = formSend.fillFormAndSend("dalila youssef","0614777771","tem7lll01u@gmail.com"); //after running tests twice change the phone number to a random phone number starting with 06XXXXXXXX and a random email
        String user = sfrp.getRegistrationConfirmation();
        Assert.assertEquals("dalila youssef",user);
        //Logout logout = new Logout(this.driver);
        //LogoutResultPage lorp = logout.logout(); // logout testing 
    }
