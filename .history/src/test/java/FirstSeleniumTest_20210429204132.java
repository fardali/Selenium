...
public class FirstSeleniumTest {
    ...
    public void testSearch() {
        ...
        Assert.assertTrue(this.waitAndReturnElement(By.className("footer-services-wrapper")).getText().contains("fait partie d'un réseau international de sites des petites annonces."));
