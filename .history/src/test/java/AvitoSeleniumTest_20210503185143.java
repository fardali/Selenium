...
public class AvitoSeleniumTest {
    ...
    public void testAll(){
        ...
        SendFormResultPage sfrp = formSend.fillFormAndSend("fardali youssef","0600000000",email); //after running tests twice change the phone number to a random phone number starting with 06XXXXXXXX and a random email
