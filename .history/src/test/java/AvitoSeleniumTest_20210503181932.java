...
public class AvitoSeleniumTest {
    ...
    public void testAll(){
        ...
        SendFormResultPage sfrp = formSend.register("daliyo7u","0642385701","tem7lll0u@gmail.com"); //after running tests twice change the phone number to a random phone number starting with 06XXXXXXXX and a random email
        //Logout logout = new Logout(this.driver);
        //LogoutResultPage lorp = logout.logout(); // logout testing 
    }
