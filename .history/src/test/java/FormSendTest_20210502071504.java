...
public class FormSendTest extends PageBase {
    ...
    public void fillFormAndSend(){
        ...
        this.waitAndReturnElement(nameInputXpath).sendKeys("Fardali Youssef\n");

        this.waitAndReturnElement(phoneNumberXpath).click();
        this.waitAndReturnElement(phoneNumberXpath).sendKeys("0644444444\n");

        this.waitAndReturnElement(phoneNumberXpath).click();
        this.waitAndReturnElement(phoneNumberXpath).sendKeys("Fardali Youssef\n");


        this.waitAndReturnElement(checkboxXpath).click();

        this.waitAndReturnElement(emailXpath).click();
        this.waitAndReturnElement(emailXpath).sendKeys("fardali@gmail.com\n");

        this.waitAndReturnElement(emailRetypeXpath).click();
        this.waitAndReturnElement(emailRetypeXpath).sendKeys("fardali@gmail.com\n");
